 ...
 */
// UE: Regardless, this needs to be exported too, as the destructor is not
//     defined inline (and therefore needs to be exported).  Making the
//     destructor inline would probably solve the problem without having to
//     export this class, but this seems like a simple solution.
class CH_EXPORT_CLASS jpeg_common_struct 
{
	public :
		jpeg_common_struct()	
			{
